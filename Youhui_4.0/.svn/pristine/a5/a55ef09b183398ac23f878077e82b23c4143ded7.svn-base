...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function checkParam()
		{
			...
			$.ajax({
    		    url: '<%=request.getContextPath()%>/ad/ad_manager?actionmethod=addAD',
    		    type: 'POST',
    		    data: {
	    			title:title,
	         ...
	         <h2 class="entry-title">新增广告</h2>
                ...
                <div id="formbox">
						...
						<p>
							...
							<input type="text" name="img1" id="img1"  value="" />&nbsp;&nbsp;&nbsp;<font color="red">尺寸：160*320</font>
						</p>
						<%
						...
						<p>
							...
							<input type="text" name="img2" id="img2"  value="" />&nbsp;&nbsp;&nbsp;<font color="red">尺寸：215*320</font>
						</p>
						<%
						...
						<iframe name="ImgUploadIfr_2"  style="display:none" >
						</iframe>
						<br/>
