...
<script>
    ...
    function saves(){
       ...
       if(sorted!='' && isreg){
    	   $.ajax({
   		    url: '<%=request.getContextPath()%>/ad/tag_item_manager?actionmethod=addMixStyleItem',
   		    type: 'POST',
   		    data: {
   		    			pids:sorted,
   		    			tagid:tagid,
			...
			<div class="inner">
				...
				<div class="onecolumn"  style="float:left; width:450px;height: 250px;">
					<div class="header" style="margin: 0;
						...
						height: 40px;
						border-bottom: 1px;
						background:../../img/bg_window_header.png;">
					<span style="display: block;
						...
						float: left;
						width: auto;
						cursor: n-resize;">拖动以调整显示顺序 </span>
					</div>
					<br class="clear">
