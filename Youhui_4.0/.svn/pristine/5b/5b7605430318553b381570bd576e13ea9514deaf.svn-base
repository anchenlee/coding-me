...
<%@page import="com.netting.bean.AdminUser"%>
...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    		...
    		<div id="header">
				<div id="header-content">
		          <img width="120px" style="margin: 20px 0 0 40px" src="<%=request.getContextPath() %>/img/header_v4.png" alt="" id="logo" />
		          <div id="header-name">管理后台</div>
		          <div id="header-nav">
