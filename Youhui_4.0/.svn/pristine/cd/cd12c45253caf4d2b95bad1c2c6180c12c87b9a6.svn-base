...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function checkParam()
		{
			...
			$.ajax({
    		    url: '<%=request.getContextPath()%>/ad/activity_manager?actionmethod=addActivity',
    		    type: 'POST',
    		    data: {
    		    			name:name,
                ...
                <div id="formbox">
                        ...
                        <p>
                       	...
                       	<p>
                             ...
                             <input type="text" name="jfbNum" id="jfbNum" value="" />
                       	</p>
                       	<p>
