...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/custom_blue.js"></script>
    ...
    <script type="text/javascript">
		...
		{
	    	location.href="<%=request.getContextPath()%>/ad/Admin_AdUp_Manager_Action?actionmethod=updateAdUpPage";
		}
    	...
    	function movePosition(id,rank,type){
    		$.ajax(
    		    	{
    	    		    url: '<%=request.getContextPath()%>/ad/Admin_AdUp_Manager_Action?actionmethod=movePosition',
    	    		    type: 'POST',
    	    		    data: {    		    			
    			    			id:id,
    			    			type:type,
		...
		<jsp:include page="../include/menu.jsp"></jsp:include>
         <div id="primary" class="hfeed">
			...
			<table class="tablewidget" width="100%"> 
	                 ...
	                 <tr id="${ad_bean.id}">
						...
						<td>
                       	...
                       	%>
                       	 ...
                       	 <td>
                       	 	 <a href="javascript:movePosition(${ad_bean.id},${ad_bean.rank},1);" ><img style="width: 16px;" alt="上移一位" title="上移一位" src="<%=request.getContextPath() %>/img/shang1.png"></a>
                       	 	 <a href="javascript:movePosition(${ad_bean.id},${ad_bean.rank},2);" ><img style="width: 16px;" alt="移至首位" title="移至首位" src="<%=request.getContextPath() %>/img/shang3.png"></a>
                       	 	  <a href="javascript:movePosition(${ad_bean.id},${ad_bean.rank},3);" ><img style="width: 16px;" alt="下移一位" title="下移一位" src="<%=request.getContextPath() %>/img/xia1.png"></a>
                       	 	  <a href="javascript:movePosition(${ad_bean.id},${ad_bean.rank},4);" ><img style="width: 16px;" alt="移至末尾" title="移至末尾" src="<%=request.getContextPath() %>/img/xia3.png"></a>
                       	 	 
                       	 </td>
	                   	<td>
							<a href="<%=request.getContextPath()%>/ad/Admin_AdUp_Manager_Action?actionmethod=updateAdUpPage&id=${ad_bean.id}">编辑</a>
                        	<a href="<%=request.getContextPath()%>/ad/Admin_AdUp_Manager_Action?actionmethod=delAdUp&id=${ad_bean.id}" onclick="return confirm('确定删除？');">删除</a>
	                   	</td>
	                </tr>
	                </c:forEach>
	    		</tbody>
              ...
              <form name="PageForm"  action="<%=request.getContextPath()%>/ad/Admin_AdUp_Manager_Action?actionmethod=showAdUpList" method="post">
