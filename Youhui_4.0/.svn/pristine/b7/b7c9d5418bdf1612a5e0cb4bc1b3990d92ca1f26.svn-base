...
public class SysCache 
{
	...
	static
	{
		...
		ActionTypeMap.put("tagStyleCategory", "标签分类");
		ActionTypeMap.put("tagStyleWaterFlowDouble", "双列瀑布流");
		ActionTypeMap.put("tagStyleSale", "特惠");		
		ActionTypeMap.put("tagStyleSingle", "单页");
		ActionTypeMap.put("tagStyleList", "列表");
		ActionTypeMap.put("tagStyleMix", "混排");
		ActionTypeMap.put("tagStyleWaterflow", "瀑布流");
		ActionTypeMap.put("searchKeyword", "关键字");
		ActionTypeMap.put("searchCategory", "淘宝类目");
		ActionTypeMap.put("searchShopNick", "卖家nick");
		ActionTypeMap.put("searchShopId", "店铺ID");
		ActionTypeMap.put("searchSellerId", "卖家ID");
		ActionTypeMap.put("tagStyleWeb", "网页");
		ActionTypeMap.put("tagStyleAppPage", "系统页面");
		ActionTypeMap.put("systemWeb", "系统浏览器");
		ActionTypeMap.put("tagStyleItem", "商品ID");
	}
	...
	{
		XTYM_Map.put("ss", "搜索");
		XTYM_Map.put("tehui", "特惠商品");
		XTYM_Map.put("scj", "收藏夹");
		XTYM_Map.put("zhsz", "设置");
		XTYM_Map.put("jhs", "聚划算");
		XTYM_Map.put("tttj", "天天特价");
		XTYM_Map.put("smbj", "扫码比价");
		XTYM_Map.put("yjfk", "意见反馈");
		XTYM_Map.put("wodetaobao", "我的淘宝");
		XTYM_Map.put("gywm", "关于我们");
		XTYM_Map.put("prd", "降价提醒");
		XTYM_Map.put("tixianguanli", "提现管理");
		XTYM_Map.put("fanliguanli", "返利管理");
		XTYM_Map.put("pahangbang", "排行榜");     
		XTYM_Map.put("xiaoxi", "消息中心");
		XTYM_Map.put("gift", "礼物");
		XTYM_Map.put("locallife", "本地生活");
	}
	...
	static
	{
		...
		ADPlatformMap.put("ipad", "ipad");
		ADPlatformMap.put("apad", "apad");
	}
