...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function checkParam()
		{
    		...
    		var url = "<%=request.getContextPath()%>/ad/Admin_Ads_Manager_Action_New?actionmethod=updateAds&id="+ad_id+"&title="+title+"&action_type="+action_type+"&action_value="+action_value+"&img="+img;
			location.href=url;
