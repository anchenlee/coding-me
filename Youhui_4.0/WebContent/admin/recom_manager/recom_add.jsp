...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function checkParam()
		{
			...
			$.ajax({
    		    url: '<%=request.getContextPath()%>/ad/recom_manager?actionmethod=addRecom',
    		    type: 'POST',
    		    data: {
    		    			title:title,
	         ...
	         <h2 class="entry-title">新增推荐</h2>
                ...
                <div id="formbox">
						...
						<p>
							...
							<input type="text" name="start_time" id="start_time" class="ui_timepicker" value="" />&nbsp;&nbsp;&nbsp;<font color="red">格式为：2013-11-9 9:23:24</font>
						</p>
						<p>
							<label><font color="#777">结束时间：</font></label>
							<input type="text" name="end_time" id="end_time" class="ui_timepicker" value="" />&nbsp;&nbsp;&nbsp;<font color="red">格式为：2013-11-9 9:23:24</font>
						</p>
						<p>
