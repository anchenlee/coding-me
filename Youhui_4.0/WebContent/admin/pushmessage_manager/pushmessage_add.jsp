...
<head>
    ...
    <script type="text/javascript">
	    ...
	    function checkParam()
		{
			...
			$.ajax({
    		    url: '<%=request.getContextPath()%>/ad/message_manager?actionmethod=addMessage',
    		    type: 'POST',
    		    data: {
    		    	title:title,
    		    	content:content,
	         ...
	         <h2 class="entry-title">新增消息</h2>
                ...
                <div id="formbox">
                        ...
                        <p>
                             ...
                             <input type="text" name="msg_content" id="msg_content" value="" />
                       	</p>
                       	<p>
						...
						<p id="p_formula" style="display: ">
                             <label><font color="#777">发送条件：</font></label>
                             <input type="text" name="formula" id="formula" value="" />
                        </p>
                        <p id="p_query" style="display: ">
                             <label><font color="#777">显示数据：</font></label>
                             <input type="text" name="query" id="query" value="" />
                       	</p>
						<p id="p_start_time" style="display: ">
						...
						<p>
							...
							<input type="text" name="img" id="img"  value="" />&nbsp;&nbsp;&nbsp;<font color="red">尺寸：140*320</font>
						</p>
						<%
