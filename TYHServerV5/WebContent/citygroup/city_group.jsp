		...
		function loadItems(pageNo)
		{
			...
			$.ajax({
			    ...
			    success: function(xml)
			    {
			    	...
			    	$(xml).find("data").find("catlist").find("cat").each(function(i){
			    		var catIDStr = $(this).children("catID").text();
			    		var catNameStr = $(this).children("catName").text();
			    		
			    		$("#cat-category-li").append("<a onclick=\"changeCat(" + catIDStr + ")\"><span>" + catNameStr + "</span></a>");
			    		
			    		if (thisCatID == catIDStr)
			    		{
			    			$("#catDIV").text(catNameStr);
			    		}
			    	});
...
<body screen_capture_injected="true" onload="loadBody()">
	<div class="toolbar">
		<div class="shop-container">
			...
			<div class="nav_left_button c-btn " id="catDIV" onclick="showCatDiv()">全部</div>
