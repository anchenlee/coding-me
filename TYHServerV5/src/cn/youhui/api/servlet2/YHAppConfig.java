...
/**
 * Servlet implementation class YHAppConfig
 */
@WebServlet("/YHAppConfig")
public class YHAppConfig extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	private static final Logger log = Logger.getLogger(YHAppConfig.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else response.getWriter().println(RespStatusBuilder.messageJson(Enums.ActionStatus.DATABASE_ERROR, ""));
	}
