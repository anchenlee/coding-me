 ...
 * @since 2013-11-18
 */
@WebServlet("/tyh2/gettxlist")
public class YHGetTXTradeList2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		int pageCount = JiFenBaoMXManager.getInstance().getTXTradePageNum(uid);
		if(pageCount == 0){
		...
		List<JiFenBaoTrade> list = JiFenBaoMXManager.getInstance().getTXTradeList(uid, pageInt);
