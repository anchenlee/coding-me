 ...
 * @since 2013-05-22
 */
@WebServlet("/tyh2/gettxlist2")
public class YHGetTXTradeList extends HttpServlet {
...
//		String uid = request.getParameter("uid");
		...
		int pageCount = JiFenBaoTradeManager.getInstance().getPageNum(uid);
		if(pageCount == 0){
		...
		List<JiFenBaoTrade> list = JiFenBaoTradeManager.getInstance().getTradeList(uid, pageInt);
