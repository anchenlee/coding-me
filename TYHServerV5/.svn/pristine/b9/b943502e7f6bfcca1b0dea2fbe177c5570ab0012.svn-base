    ...
    <div id="content">
        <div id="exchange" style="padding-bottom:10%;background:#ececec" data-header="none" class="panel"><!--    the    兑换中心  选择你的充值价格 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
            ...
            <div class="panel_content">
                ...
                <p id="duihuanjia" style="margin: 7% 0;"><span class="s_f">兑换价：<img style="display: inline-block;vertical-align: top;width: 15%;margin:0 3%" src="img/middle_autumn/9discount.png" alt=""/><span class="jfb_nums f_r b_f">900</span>个集分宝</span></p>
                <p id="not_enough" style="visibility:hidden;text-align:center;margin:7% 0;" class="tc">
                	<span class="tc f_r" style="font-size:4rem">兑换需要<span class="jfb_nums">900</span>个集分宝</span><br />
