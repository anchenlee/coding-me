...
<div id="afui">
    <div id="content">
        <div style="background:#fedc7a" id="start" selected="true" data-header="none" class="panel"><!--    the 兑换中心首页!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
            <div style="background: #fc3764">
                <img class="width100" src="img/middle_autumn/img2_1.jpg" alt=""/>
                <img class="width100" onclick="javascript:window.location.href='http://wvs.m.taobao.com/?pid=mm_28187215_7782231_26280921&backHiddenFlag=1&sche=suishou&sche=suishou'" src="img/middle_autumn/img2_btn1.png" alt=""/>
                ...
                <img class="width100" src="img/middle_autumn/img2_6.jpg" alt=""/>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function weixin_share(){
    	var share_str = '{"sns_type":"weixin","request_code":"","share_type":"activity_type","click_url":"http://v2.api.njnetting.cn/huafei/share.html","img_url":"http://static.etouch.cn/suishou/ad_img/317weypnjpg.jpg","content":"话费充值9折，到哪都没的低价！充完再送集分宝，赶紧来参加哦！","title":"话费9折兑换","item_id":"","activity_key":"6xq2thmr","channel":"own","jifenbao_num":"0","sst":""}';
    	local_info.share(share_str);
    }

    function friend_share(){
    	var share_str = '{"sns_type":"pengyou","request_code":"","share_type":"activity_type","click_url":"http://v2.api.njnetting.cn/huafei/share.html","img_url":"http://static.etouch.cn/suishou/ad_img/317weypnjpg.jpg","content":"话费充值9折，到哪都没的低价！充完再送集分宝，赶紧来参加哦！","title":"话费9折兑换","item_id":"","activity_key":"6xq2thmr","channel":"own","jifenbao_num":"0","sst":""}';
    	local_info.share(share_str);
    }

    function xinlang_share(){
    	var share_str = '{"sns_type":"weibo","request_code":"","share_type":"activity_type","click_url":"http://v2.api.njnetting.cn/huafei/share.html","img_url":"http://static.etouch.cn/suishou/ad_img/317weypnjpg.jpg","content":"话费充值9折，到哪都没的低价！充完再送集分宝，赶紧来参加哦！","title":"话费9折兑换","item_id":"","activity_key":"6xq2thmr","channel":"own","jifenbao_num":"0","sst":""}';
    	local_info.share(share_str);
    }
</script>
</body>
