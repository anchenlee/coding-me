 ...
 * sorted_set_key:X.CachePrefix.FAV_USER_2_SHOPS.$uid { score member time itemId
 * 137... [{.....}] }
 * 
 * ***/
public class FavUser2ShopsCacher {
	private int PAGE_SIZE = 20;
	private String cacheKey = "";

	public FavUser2ShopsCacher(long uid) {
		this.cacheKey = new StringBuilder(X.CachePrefix.FAV_USER_2_SHOPS)
	...
	public ArrayList<String> getShops() {
		...
		RedisRunner<ArrayList<String>> runner = new RedisRunner<ArrayList<String>>() {
			...
			public ArrayList<String> run(Jedis jedis)
				...
				Set<String> set = jedis.zrange(cacheKey, 0, -1);
				if (set != null) {
	...
	public ArrayList<String> getShops(final int page) {
