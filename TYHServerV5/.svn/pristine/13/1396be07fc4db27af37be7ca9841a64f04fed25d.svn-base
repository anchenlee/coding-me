...
public class TeJiaCateogry2Cacher {
	protected static final String CATEGORY_PREFIX = "youhui.cn.tj2cateory";

	static TeJiaCateogry2Cacher instance = new TeJiaCateogry2Cacher();
	
	public static final int pageSize = 10 ;

	public static TeJiaCateogry2Cacher getInstance() {
		return instance;
	}
