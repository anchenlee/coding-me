...
var popWin = {
    ...
    showWin: function(width, height, title, src) {
            ...
            inntHtml += '</div>'
            inntHtml += '<iframe id="frame" width="' + width + '" height="' + iframeHeight + '" frameborder="0" scrolling="' + this.scrolling + '" src="' + src + '"></iframe>';

            $("body").append(inntHtml);
            this.int();
        },

    mouseClose: function() { //��꿿��رհ�ť ��ť���
