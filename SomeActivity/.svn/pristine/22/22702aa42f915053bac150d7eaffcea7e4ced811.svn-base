...
<%
    ...
    String url = "http://d.b17.cn/sactivity/fh/f405.jsp?u=" + uid64;
    String shareStr = "{\"isshare\":true,\"title\":\"5月分红帐单生成喽！！\",\"content\":\"快来看看5月份赚了多少，随手君为您生成5月分红账单喽！点我省钱——淘宝购物就用【随手优惠】\",\"clickurl\":\""+ url +"\",\"imgurl\":\"http://static.etouch.cn/suishou/ad_img/9fcj6xtwn1.jpg\",\"activity_key\":\"1da7gktm\",\"channel\":\"weixin,weibo,pengyou,txwb,qqkj,renren,duoban,email,sm\"}";
   ...
   // String cUrl = "suishou://youhui.cn?action_title="+ URLEncoder.encode("5月分红帐单生成喽", "UTF-8")+"&action_value=" + URLEncoder.encode(newShareStr, "UTF-8")+"&action_type=youhuishare&jump_from=suishou";
   	...
   	String cUrl = ShareUtil.getShareUrl("5月分红帐单生成喽", shareStr, version);
