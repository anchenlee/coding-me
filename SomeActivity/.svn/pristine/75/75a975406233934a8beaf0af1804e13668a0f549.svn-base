...
<%
    ...
    String url = "http://d.b17.cn/sactivity/fh/f408.jsp?u=" + uid64;
    String shareStr = "{\"isshare\":true,\"title\":\"8月分红账单\",\"content\":\"快来看看8月份赚了多少，优惠君为您生成8月分红账单喽！点我省钱——淘宝购物就用【随手优惠】\",\"clickurl\":\""+ url +"\",\"imgurl\":\"http://static.etouch.cn/suishou/ad_img/2zzqjzw3uys.jpg\",\"activity_key\":\"1da7gktm\",\"channel\":\"weixin,weibo,pengyou,txwb,qqkj,renren,duoban,email,sm\"}";
    
    //String newShareStr = Base64.encode(shareStr.getBytes("UTF-8"));
    
   // String cUrl = "suishou://youhui.cn?action_title="+ URLEncoder.encode("5月分红帐单生成喽", "UTF-8")+"&action_value=" + URLEncoder.encode(newShareStr, "UTF-8")+"&action_type=youhuishare&jump_from=suishou";
   
   	String cUrl = ShareUtil.getShareUrl("8月分红账单", shareStr, version);
    
    Fenhong fh = FenhongDAO.getInstance().getFenhong(uid, "2014", "08");
%>
