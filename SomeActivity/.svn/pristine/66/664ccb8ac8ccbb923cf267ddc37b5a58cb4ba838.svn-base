...
<%
    ...
    String url = "http://d.b17.cn/sactivity/fh/f404.jsp?u=" + uid64;
    String shareStr = "{\"isshare\":true,\"title\":\"4月分红帐单生成喽！！\",\"content\":\"随手君发放4月分红帐单生成喽！点我省钱——淘宝购物就用【随手优惠】\",\"clickurl\":\""+ url +"\",\"imgurl\":\"http://static.etouch.cn/suishou/ad_img/fijkdsewa0.jpg\",\"activity_key\":\"1da7gktm\",\"channel\":\"weixin,weibo,pengyou,txwb,qqkj,renren,duoban,email,sm\"}";
    
    String newShareStr = Base64.encode(shareStr.getBytes("UTF-8"));
    
    String cUrl = "suishou://youhui.cn?action_title="+ URLEncoder.encode("4月分红帐单生成喽", "UTF-8")+"&action_value=" + URLEncoder.encode(newShareStr, "UTF-8")+"&action_type=youhuishare&jump_from=suishou";
    
    Fenhong fh = FenhongDAO.getInstance().getFenhong(uid, "2014", "04");
%>
