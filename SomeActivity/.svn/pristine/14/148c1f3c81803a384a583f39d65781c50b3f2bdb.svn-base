...
<%
    ...
    String url = "http://d.b17.cn/sactivity/fh/f406.jsp?u=" + uid64;
    String shareStr = "{\"isshare\":true,\"title\":\"6月分红帐单生成喽！！\",\"content\":\"6月我又省了不少钱，全靠用了随手优惠购物！点我省钱——淘宝购物就用【随手优惠】\",\"clickurl\":\""+ url +"\",\"imgurl\":\"http://static.etouch.cn/suishou/ad_img/1jhjyj6lvty.jpg\",\"activity_key\":\"1da7gktm\",\"channel\":\"weixin,weibo,pengyou,txwb,qqkj,renren,duoban,email,sm\"}";
   ...
   // String cUrl = "suishou://youhui.cn?action_title="+ URLEncoder.encode("5月分红帐单生成喽", "UTF-8")+"&action_value=" + URLEncoder.encode(newShareStr, "UTF-8")+"&action_type=youhuishare&jump_from=suishou";
   	...
   	String cUrl = ShareUtil.getShareUrl("6月分红帐单生成喽", shareStr, version);
    
    Fenhong fh = FenhongDAO.getInstance().getFenhong(uid, "2014", "06");
%>
