...
public class VersionUtil {
	...
	private static int iphoneNormalVersion = Integer.parseInt("4.0.0".replaceAll("\\.", ""));    //iphone的正常最低版本
	private static int ipadNormalVersion = Integer.parseInt("3.4.0".replaceAll("\\.", ""));   //ipad的正常最低版本
	private static int androidNormalVersion = Integer.parseInt("4.0.0".replaceAll("\\.", ""));   //android的正常最低版本
