...
<%
   ...
   // String taobaoNick = UserDAO.getInstance().getTBNick(uid);
    ...
    String url = "http://d.b17.cn/sactivity/fh/fd403.jsp?u=" + uid64;
    String shareStr = "{\"isshare\":true,\"title\":\"3月集分宝红包发放啦！\",\"content\":\"随手君发放3月购物额外奖励红包啦！等级越高分红越多！点我省钱——淘宝购物就用【随手优惠】\",\"clickurl\":\""+ url +"\",\"imgurl\":\"http://bcs.duapp.com/taoyouhui-ad/adImg/63eobjy0r16.jpg\",\"activity_key\":\"08btqisk\",\"channel\":\"weixin,weibo,pengyou,txwb,qqkj,renren,duoban,email,sm\"}";
    
    String newShareStr = Base64.encode(shareStr.getBytes("UTF-8"));
    
    String cUrl = "suishou://youhui.cn?action_title="+ URLEncoder.encode("3月集分宝红包发放啦", "UTF-8")+"&action_value=" + URLEncoder.encode(newShareStr, "UTF-8")+"&action_type=youhuishare&jump_from=suishou";
