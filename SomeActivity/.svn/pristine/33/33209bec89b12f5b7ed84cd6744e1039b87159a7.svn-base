...
<%
   ...
   // String taobaoNick = UserDAO.getInstance().getTBNick(uid);
    ...
    String url = "http://d.b17.cn/sactivity/fh/fd404.jsp?u=" + uid64;
    
    String shareStr = "{\"isshare\":true,\"title\":\"4月集分宝红包发放啦！\",\"content\":\"随手君发放4月购物额外奖励红包啦！用的越久，赚的越多！点我省钱——淘宝购物就用【随手优惠】\",\"clickurl\":\""+ url +"\",\"imgurl\":\"http://static.etouch.cn/suishou/ad_img/qhatur6bo.jpg\",\"activity_key\":\"08btqisk\",\"channel\":\"weixin,weibo,pengyou,txwb,qqkj,renren,duoban,email,sm\"}";
  ...
  String cUrl = ShareUtil.getShareUrl("4月集分宝红包发放啦", shareStr, version);
