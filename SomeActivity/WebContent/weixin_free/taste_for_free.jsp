...
<%
	...
	long t82719 = 1409137200000l;
	
	if(now >= t82719){
		//step1click = "javascript:location.href='http://taoquan.taobao.com/coupon/unify_apply.htm?sellerId=2058908346&activityId=142804925'";
		step2click = "javascript:location.href='http://b17.cn/XnJ14j'";
	}
