...
<%
   ...
   // String taobaoNick = UserDAO.getInstance().getTBNick(uid);
    ...
    String url = "http://d.b17.cn/sactivity/fh/fd407.jsp?u=" + uid64;
    
    String shareStr = "{\"isshare\":true,\"title\":\"7月集分宝红包发放啦！\",\"content\":\"随手君发放7月购物额外奖励红包啦！用的越久，赚的越多！点我省钱——淘宝购物就用【随手优惠】\",\"clickurl\":\""+ url +"\",\"imgurl\":\"http://static.etouch.cn/suishou/ad_img/2lwll46cqrw.jpg\",\"activity_key\":\"08btqisk\",\"channel\":\"weixin,weibo,pengyou,txwb,qqkj,renren,duoban,email,sm\"}";
  ...
  String cUrl = ShareUtil.getShareUrl("7月集分宝红包发放啦", shareStr, version);
